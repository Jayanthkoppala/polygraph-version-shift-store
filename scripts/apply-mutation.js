...
const mutations = {
  ...
  'selector-break': (html) => html
    .replaceAll('class="product-price"', 'class="price-value"')
    .replaceAll('class="money-widget__value"', 'class="amount-value"')
    .replaceAll('class="commerce-amount"', 'class="amount-value"')
    .replaceAll('class="listing-price__amount"', 'class="amount-value"'),
